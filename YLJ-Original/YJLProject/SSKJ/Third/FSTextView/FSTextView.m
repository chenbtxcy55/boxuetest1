...
CGFloat const kFSTextViewPlaceholderVerticalMargin = 10; ///< placeholder垂直方向边距
CGFloat const kFSTextViewPlaceholderHorizontalMargin = 0.0; ///< placeholder水平方向边距
...
- (BOOL)becomeFirstResponder
{
    ...
    //change 响应时隐藏placeholderLabel
    self.placeholderLabel.hidden = become;
    // 成为第一响应者时注册通知监听文本变化
...
- (BOOL)resignFirstResponder
{
    ...
    //change 响应移除时显示placeholderLabel
