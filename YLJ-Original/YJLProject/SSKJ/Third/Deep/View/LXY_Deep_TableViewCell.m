...
-(UIView *)buyBackView
{
    if (nil == _buyBackView) {
        ...
        _buyBackView.backgroundColor = [UIColor lxy_fallColor];
    }
    return _buyBackView;
}
...
-(UILabel *)buyIndexLabel
{
    if (nil == _buyIndexLabel) {
        _buyIndexLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(10)) textColor:[UIColor lxy_volumeColor] frame:CGRectMake(ScaleW(15), 0, ScaleW(12), kCell_Height) textAlignment:NSTextAlignmentCenter];
...
-(UILabel *)buyAmmountLabel
{
    if (nil == _buyAmmountLabel) {
        _buyAmmountLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(10)) textColor:kMainWihteColor frame:CGRectMake(self.buyIndexLabel.right + ScaleW(5), 0, ScaleW(100), kCell_Height) textAlignment:NSTextAlignmentLeft];
    }
...
-(UILabel *)buyPriceLabel
{
    if (nil == _buyPriceLabel) {
        _buyPriceLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(10)) textColor:[UIColor lxy_fallColor] frame:CGRectMake(self.buyAmmountLabel.right, 0, ScreenWidth / 2 - self.buyAmmountLabel.right - ScaleW(3), kCell_Height) textAlignment:NSTextAlignmentRight];
    }
...
-(UIView *)sellBackView
{
    if (nil == _sellBackView) {
        ...
        _sellBackView.backgroundColor = [UIColor lxy_riseColor];
...
-(UILabel *)sellPriceLabel
{
    if (nil == _sellPriceLabel) {
        _sellPriceLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(10)) textColor:[UIColor lxy_riseColor] frame:CGRectMake(ScreenWidth / 2 + ScaleW(3), 0, self.buyPriceLabel.width, kCell_Height) textAlignment:NSTextAlignmentLeft];
    }
...
-(UILabel *)sellAmmountLabel
{
    if (nil == _sellAmmountLabel) {
        _sellAmmountLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(10)) textColor:kMainWihteColor frame:CGRectMake(self.sellPriceLabel.right, 0, self.buyAmmountLabel.width, kCell_Height) textAlignment:NSTextAlignmentRight];
    }
...
-(UILabel *)sellIndexLabel
{
    if (nil == _sellIndexLabel) {
        _sellIndexLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(10)) textColor:[UIColor lxy_volumeColor] frame:CGRectMake(ScreenWidth - ScaleW(15) - ScaleW(12), 0, ScaleW(12), kCell_Height) textAlignment:NSTextAlignmentCenter];
    }
...
-(void)setBuyModel:(LXY_DeepModel *)buyModel sellModel:(LXY_DeepModel *)sellModel index:(NSInteger)index maxVolume:(double)maxVolume
{
    self.buyIndexLabel.text = [NSString stringWithFormat:@"%ld",index + 1];
    self.buyPriceLabel.text = buyModel.price;
    self.buyAmmountLabel.text = buyModel.volume;
    self.sellIndexLabel.text = [NSString stringWithFormat:@"%ld",index + 1];
    self.sellPriceLabel.text = sellModel.price;
    self.sellAmmountLabel.text = sellModel.volume;
