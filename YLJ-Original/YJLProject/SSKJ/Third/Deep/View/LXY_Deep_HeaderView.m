...
-(UILabel *)buyIndexLabel
{
    if (nil == _buyIndexLabel) {
        _buyIndexLabel = [WLTools allocLabel:@"买入" font:systemFont(ScaleW(10)) textColor:[UIColor lxy_volumeColor] frame:CGRectMake(ScaleW(15), 0, ScaleW(25), kCell_Height) textAlignment:NSTextAlignmentCenter];
...
{
    if (nil == _priceLabel) {
        _priceLabel = [WLTools allocLabel:@"价格(AB)" font:systemFont(ScaleW(10)) textColor:[UIColor lxy_volumeColor] frame:CGRectMake(self.buyAmmountLabel.right, 0, ScaleW(150), kCell_Height) textAlignment:NSTextAlignmentCenter];
