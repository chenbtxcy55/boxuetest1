...
{
    self.buyModelArray = [LXY_DeepModel mj_objectArrayWithKeyValuesArray:data[@"alias"]];
    
    self.sellModelArray = [LXY_DeepModel mj_objectArrayWithKeyValuesArray:data[@"blias"]];
    
    self.tableView.height = (self.buyModelArray.count + 1) * kCell_Height;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setBuyModel:buyModel sellModel:sellModel index:indexPath.row maxVolume:self.maxVolume];
    return cell;
}
