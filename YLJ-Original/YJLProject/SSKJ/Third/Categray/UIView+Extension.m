...
//    [textField setValue:[UIFont systemFontOfSize:placeHolderFont] forKeyPath:@"_placeholderLabel.font"];
    ...
    NSMutableAttributedString *placeholderString1 = [[NSMutableAttributedString alloc] initWithString: placeText attributes:@{NSForegroundColorAttributeName : placeHolderTextColor,NSFontAttributeName:[UIFont systemFontOfSize:placeHolderFont]}];
