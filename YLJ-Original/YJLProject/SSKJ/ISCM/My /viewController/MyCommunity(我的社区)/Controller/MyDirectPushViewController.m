...
/*
 我的直推
 */
#import "MyDirectPushViewController.h"
...
@interface MyDirectPushViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MyDirectPushViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.twoLab.text = dic[@"level"];
    cell.threeLab.text = dic[@"lerver"];
    cell.fourLab.text =dic[@"reg_time"] ;
