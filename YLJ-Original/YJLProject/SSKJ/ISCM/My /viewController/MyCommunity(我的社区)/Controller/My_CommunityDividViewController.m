//
//  My_CommunityDividViewController.m
//  SSKJ
//
...
/*
 加权分红
 */
#import "My_CommunityDividViewController.h"
...
#define kPageSize 30
@interface My_CommunityDividViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation My_CommunityDividViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell layoutFenHong];
    cell.oneLab.text = dic[@"ymoney"];
    cell.twoLab.text =  dic[@"money"];
