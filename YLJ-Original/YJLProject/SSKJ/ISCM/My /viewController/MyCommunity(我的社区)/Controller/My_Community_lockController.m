...
/*
 锁仓释放
 */
#import "My_Community_lockController.h"
...
#define kPageSize 30
@interface My_Community_lockController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation My_Community_lockController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *dic = self.dataArray[indexPath.row];
     [cell layoutSuoCang];
    cell.oneLab.text = dic[@"money"];
    cell.twoLab.text = [WLTools convertTimestamp: [dic[@"add_time"] doubleValue] andFormat:@"yyyy-MM-dd"];
