...
/*
 分享奖励
 */
#import "MyIncomeShareViewController.h"
...
#define kPageSize 10
@interface MyIncomeShareViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MyIncomeShareViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell layoutChildViews];
    cell.oneLab.text = dic[@"user_id"];
    cell.twoLab.text = dic[@"lay"];
    cell.threeLab.text = [WLTools noroundingStringWith:[dic[@"fee_yongjin"] doubleValue] afterPointNumber:4];
...
//    [self.dataArray removeAllObjects];
    ...
    [pamas setObject:@(1) forKey:@"order_type"];
