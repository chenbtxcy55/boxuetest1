//
//  MyIncomeManageViewController.m
//  SSKJ
//
...
/*
 管理奖励
 */
#import "MyIncomeManageViewController.h"
...
@interface MyIncomeManageViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MyIncomeManageViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.threeLab.text = [WLTools noroundingStringWith:[dic[@"money"] doubleValue] afterPointNumber:4];
...
//    [self.dataArray removeAllObjects];
    ...
    [pamas setObject:@(5) forKey:@"order_type"];
