//
//  MyIncomeWelfareViewController.m
//  SSKJ
//
...
/*
 福利奖
 */
#import "MyIncomeWelfareViewController.h"
...
#define kPageSize 10
@interface MyIncomeWelfareViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MyIncomeWelfareViewController
...
- (MyIncomeBaseHeardView *)heardView{
    if (!_heardView) {
        ...
        _heardView.oneLab.text = SSKJLocalized(@"新增业绩(USDT)", nil);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell layoutFenHong];
    cell.oneLab.text = [WLTools noroundingStringWith:[dic[@"fee"] doubleValue] afterPointNumber:4];
    cell.twoLab.text = [WLTools noroundingStringWith:[dic[@"fee_yongjin"] doubleValue] afterPointNumber:4];
...
//    [self.dataArray removeAllObjects];
    ...
    [pamas setObject:@(3) forKey:@"order_type"];
