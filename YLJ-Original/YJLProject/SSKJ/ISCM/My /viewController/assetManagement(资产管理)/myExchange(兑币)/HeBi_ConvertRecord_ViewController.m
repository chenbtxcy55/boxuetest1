...
static NSString *cellID = @"YLJExchangeListCell";
...
-(UITableView *)tableView
{
    if (nil == _tableView) {
        ...
        [_tableView registerClass:[YLJExchangeListCell class] forCellReuseIdentifier:cellID];
        WS(weakSelf);
...
{
    YLJExchangeListCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
...
-(void)requestRecordList
{
    ...
    WS(weakSelf);
    [[WLHttpManager shareManager]requestWithURL_HTTPCode:JB_Account_Malls_Recode RequestType:RequestTypeGet Parameters:params Success:^(NSInteger statusCode, id responseObject) {
