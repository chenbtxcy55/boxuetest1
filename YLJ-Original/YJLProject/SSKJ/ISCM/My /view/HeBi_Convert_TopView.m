...
-(UIView *)chiyouBackView
{
    if (nil == _chiyouBackView) {
        ...
        _chiyouBackView.backgroundColor = kSubBackgroundColor;
...
-(UILabel *)chiyouTitleLabel
{
    if (nil == _chiyouTitleLabel) {
        _chiyouTitleLabel = [WLTools allocLabel:SSKJLocalized(@"持有资产", nil) font:systemFont(ScaleW(14)) textColor:SKRandomColor frame:CGRectMake(0, ScaleW(15), self.chiyouBackView.width, ScaleW(15)) textAlignment:NSTextAlignmentCenter];
    }
...
{
    if (nil == _chiyouLabel) {
        _chiyouLabel = [WLTools allocLabel:SSKJLocalized(@"", nil) font:systemFont(ScaleW(14)) textColor:SKRandomColor frame:CGRectMake(0, self.chiyouTitleLabel.bottom + ScaleW(19), self.chiyouBackView.width, ScaleW(15)) textAlignment:NSTextAlignmentCenter];
    }
    return _chiyouLabel;
}
...
-(UIButton *)exchangeButton
{
    if (nil == _exchangeButton) {
        ...
        _exchangeButton.backgroundColor = kSubBackgroundColor;
...
-(UIView *)duihuanBackView
{
    if (nil == _duihuanBackView) {
        ...
        _duihuanBackView.backgroundColor = kSubBackgroundColor;
...
-(UILabel *)duihuanTitleLabel
{
    if (nil == _duihuanTitleLabel) {
        _duihuanTitleLabel = [WLTools allocLabel:SSKJLocalized(@"兑换资产", nil) font:systemFont(ScaleW(14)) textColor:SKRandomColor frame:CGRectMake(0, ScaleW(15), self.duihuanBackView.width, ScaleW(15)) textAlignment:NSTextAlignmentCenter];
    }
...
-(UILabel *)duihuanLabel
{
    if (nil == _duihuanLabel) {
        _duihuanLabel = [WLTools allocLabel:SSKJLocalized(@"", nil) font:systemFont(ScaleW(14)) textColor:SKRandomColor frame:CGRectMake(0, self.duihuanTitleLabel.bottom + ScaleW(19), self.duihuanBackView.width, ScaleW(15)) textAlignment:NSTextAlignmentCenter];
    }
