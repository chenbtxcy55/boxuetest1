...
-(UILabel *)duihuanAmmountTitleLabel
{
    if (nil == _duihuanAmmountTitleLabel) {
        _duihuanAmmountTitleLabel = [WLTools allocLabel:SSKJLocalized(@"兑换数量", nil) font:systemFont(ScaleW(14)) textColor:[UIColor blackColor] frame:CGRectMake(ScaleW(15), 0, ScaleW(62), ScaleW(50)) textAlignment:NSTextAlignmentLeft];
    }
...
-(UILabel *)duihuanUnitLabel
{
    if (nil == _duihuanUnitLabel) {
        _duihuanUnitLabel = [WLTools allocLabel:SSKJLocalized(@"ETH", nil) font:systemFont(ScaleW(14)) textColor:[UIColor blackColor] frame:CGRectMake(ScreenWidth - ScaleW(15) - ScaleW(50), 0, ScaleW(50), ScaleW(50)) textAlignment:NSTextAlignmentRight];
    }
...
-(UITextField *)duihuanTextField
{
    if (nil == _duihuanTextField) {
        ...
        _duihuanTextField.textColor = SKRandomColor;
        _duihuanTextField.font = systemFont(ScaleW(14));

//        [_duihuanTextField setValue:[UIColor colorWithRed:150.0f/255.0f green:150.0f/255.0f blue:150.0f/255.0f alpha:1.0f] forKeyPath:@"_placeholderLabel.textColor"];
        
        NSMutableAttributedString *placeholderString = [[NSMutableAttributedString alloc] initWithString:@"0.00" attributes:@{NSForegroundColorAttributeName : [UIColor colorWithRed:150.0f/255.0f green:150.0f/255.0f blue:150.0f/255.0f alpha:1.0f]}];
        _duihuanTextField.attributedPlaceholder = placeholderString;
...
-(UILabel *)zichanAmmountTitleLabel
{
    if (nil == _zichanAmmountTitleLabel) {
        _zichanAmmountTitleLabel = [WLTools allocLabel:SSKJLocalized(@"资产数量", nil) font:systemFont(ScaleW(14)) textColor:[UIColor blackColor] frame:CGRectMake(ScaleW(15), self.lineView.bottom, ScaleW(62), ScaleW(50)) textAlignment:NSTextAlignmentLeft];
    }
...
-(UILabel *)zichanUnitLabel
{
    if (nil == _zichanUnitLabel) {
        _zichanUnitLabel = [WLTools allocLabel:SSKJLocalized(@"YEC", nil) font:systemFont(ScaleW(14)) textColor:[UIColor blackColor] frame:CGRectMake(ScreenWidth - ScaleW(15) - ScaleW(50), self.zichanAmmountTitleLabel.y, ScaleW(50), ScaleW(50)) textAlignment:NSTextAlignmentRight];
    }
...
-(UITextField *)zichanTextField
{
    if (nil == _zichanTextField) {
        ...
        _zichanTextField.textColor = SKRandomColor;
        _zichanTextField.font = systemFont(ScaleW(14));
        
//        [_zichanTextField setValue:[UIColor colorWithRed:150.0f/255.0f green:150.0f/255.0f blue:150.0f/255.0f alpha:1.0f] forKeyPath:@"_placeholderLabel.textColor"];
        
        NSMutableAttributedString *placeholderString = [[NSMutableAttributedString alloc] initWithString:@"0.00" attributes:@{NSForegroundColorAttributeName : [UIColor colorWithRed:150.0f/255.0f green:150.0f/255.0f blue:150.0f/255.0f alpha:1.0f]}];
        
        _zichanTextField.attributedPlaceholder = placeholderString;
...
-(void)inputChanged:(UITextField *)textField
{
    ...
    double zichan = ammount * self.exchangeFee.doubleValue;
