...
-(UIButton *)mainHiddenButton
{
    if (nil == _mainHiddenButton) {
        ...
        [_mainHiddenButton setImage:[UIImage imageNamed:@"eye_yes"] forState:UIControlStateNormal];
        [_mainHiddenButton setImage:[UIImage imageNamed:@"eye_no"] forState:UIControlStateSelected];
...
-(UIButton *)subHiddenButton
{
    if (nil == _subHiddenButton) {
        ...
        [_subHiddenButton setImage:[UIImage imageNamed:@"eye_yes"] forState:UIControlStateNormal];
        [_subHiddenButton setImage:[UIImage imageNamed:@"eye_no"] forState:UIControlStateSelected];
...
-(void)addSubAccessory
{
    ...
    for (int i = 0; i < self.subAccessoryArray.count; i++) {
        ...
        [btn setTitle:title forState:UIControlStateNormal];
        [btn setTitleColor:kTextLightBlueColor forState:UIControlStateNormal];
        [btn setTitleColor:kTitleColor forState:UIControlStateSelected];
        btn.titleLabel.font = systemFont(ScaleW(13));
