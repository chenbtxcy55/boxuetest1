...
-(void)addButtons
{
    ...
    for (int i = 0; i < self.titlesArray.count; i++) {
        ...
        if ( i== 5 || i == 6) {
            ...
            [btn setImage:[UIImage imageNamed:@"right_downarrow"] forState:UIControlStateNormal];
...
-(UIView *)lineView
{
    if (nil == _lineView) {
        ...
        _lineView = [[UIImageView alloc]initWithFrame:CGRectMake(0, self.height - ScaleW(3), ScaleW(25), ScaleW(3))];
        _lineView.backgroundColor = kMainWihteColor;
