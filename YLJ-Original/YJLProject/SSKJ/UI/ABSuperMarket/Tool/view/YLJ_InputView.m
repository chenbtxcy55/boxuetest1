...
{
    if (nil == _textField) {
        _textField = [[UITextField alloc]initWithFrame:CGRectMake(self.titleLab.right + _leftGap, 0, self.width - self.titleLab.right - _leftGap -(_isSecured?self.secureButotn.width:0) , self.height - ScaleW(1))];
        _textField = [[UITextField alloc]initWithFrame:CGRectMake(0, 0, self.width - self.titleLab.right - _leftGap -(_isSecured?self.secureButotn.width:0) , self.height - 1)];
...
{
    if (nil == _lineView) {
        _lineView = [[UIView alloc]initWithFrame:CGRectMake(0, self.height - ScaleW(0.5), self.width, ScaleW(1))];
