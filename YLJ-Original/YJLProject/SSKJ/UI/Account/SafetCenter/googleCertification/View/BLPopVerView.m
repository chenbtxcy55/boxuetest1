...
@property (weak, nonatomic) IBOutlet BLLabel *titleLabel;
@property (weak, nonatomic) IBOutlet UIButton *quxiaoBtn;

@property (weak, nonatomic) IBOutlet UIView *innerView;

@property (weak, nonatomic) IBOutlet BLLabel *phoneNumberLabel;
...
//            self.confirmButton.backgroundColor = kNormalColor;
            self.code = _codeTextField.text;
        }else{
            _confirmButton.enabled = NO;
...
//        _confirmButton.backgroundColor = kNormalColor;
//        if (_codeTextField.text.length >= 6) {
//            self.code = _codeTextField.text;
//            [self verCode:_codeTextField.text];
//        }
...
//                weakSelf.confirmButton.backgroundColor = kNormalColor;
//                [MBProgressHUD showError:json[@"msg"]];
//            });
//        } else {
//            dispatch_async(dispatch_get_main_queue(), ^{
//                weakSelf.confirmButton.enabled = NO;
//                weakSelf.confirmButton.backgroundColor = kDisableColor;
//                [MBProgressHUD showError:json[@"msg"]];
//            });
//        }
...
- (IBAction)requestSMSCode:(UIButton *)sender {
    ...
    if ([RegularExpression validateMobile:_phoneNumber] ) {
        if ([self.fromVC isEqualToString:@"google"]) {
...
- (void)setPhoneNumber:(NSString *)phoneNumber {
    ...
    NSString *mobileStr;
    if ([RegularExpression validateMobile:phoneNumber] ) {
