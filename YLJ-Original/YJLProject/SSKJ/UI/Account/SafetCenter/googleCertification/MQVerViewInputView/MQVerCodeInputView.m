...
//        subView.borderWidth = (0.4);
        ...
        UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(51 * i, self.height - 1, 50 - 5, 1)];
...
//        }];
        ...
        UIBezierPath *path = [UIBezierPath bezierPathWithRect:CGRectMake((CGRectGetHeight(self.frame)-2)/2,5,20,1)];
