...
- (UIButton *)privacyButton
{
    if (nil == _privacyButton) {
        ...
        [_privacyButton setTitleColor:kLineGrayColor forState:UIControlStateNormal];
...
- (UIButton *)serviceButton
{
    if (nil == _serviceButton) {
        ...
        [_serviceButton setTitleColor:kLineGrayColor forState:UIControlStateNormal];
...
- (UILabel *)versionLabel
{
    if (nil == _versionLabel) {
        ...
        _versionLabel = [WLTools allocLabel:[NSString stringWithFormat:@"%@V%@",SSKJLocalized(@"当前版本", nil),app_Version] font:systemFont(ScaleW(12)) textColor:kLineGrayColor frame:CGRectMake(0, self.lineView.bottom + ScaleW(17), self.width, ScaleW(12)) textAlignment:NSTextAlignmentCenter];
    }
...
- (UILabel *)messageLabel
{
    if (nil == _messageLabel) {
        ...
        _messageLabel = [WLTools allocLabel:@"Copying © 2019 GOCOIN.All rights reserved" font:systemFont(ScaleW(12)) textColor:kLineGrayColor frame:CGRectMake(0, self.versionLabel.bottom + ScaleW(8), self.width, ScaleW(12)) textAlignment:NSTextAlignmentCenter];
    }
...
-(void)addButtons
{
    ...
    self.imageBackView.width = startX - ScaleW(10);
...
-(UIView *)imageBackView
{
    if (nil == _imageBackView) {
        _imageBackView = [[UIView alloc]initWithFrame:CGRectMake(0, self.messageLabel.bottom + ScaleW(20), 0, ScaleW(14))];
