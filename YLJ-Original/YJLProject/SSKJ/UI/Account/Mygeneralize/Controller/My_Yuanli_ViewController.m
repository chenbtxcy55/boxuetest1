...
-(void)requestYuanliList
{
    ...
    WS(weakSelf);
    [[WLHttpManager shareManager]requestWithURL_HTTPCode:JB_YongJin_Detail__URL RequestType:RequestTypePost Parameters:params Success:^(NSInteger statusCode, id responseObject) {
