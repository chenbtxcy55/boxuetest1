...
@interface SSKJ_Service_AlertView ()<UIScrollViewDelegate>
...
@implementation SSKJ_Service_AlertView
...
+(void)showWithModel:(NSString *)content confirmBlock:(void(^)(void))confirmblock cancleBlock:(void(^)(void))cancleBlock
{
    ...
    SSKJ_Service_AlertView *versionAlertView = [[SSKJ_Service_AlertView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight)];
