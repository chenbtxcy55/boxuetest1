...
{
    if (nil == _titleLabel) {
        _titleLabel = [WLTools allocLabel:_title font:_font textColor: kMainTextColor frame:CGRectMake(_leftGap, self.textField.y - ScaleW(19), ScreenWidth - 2 * _leftGap, ScaleW(13.5)) textAlignment:NSTextAlignmentLeft];
