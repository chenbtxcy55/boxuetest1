...
{
    if (nil == _titleLabel) {
        _titleLabel = [WLTools allocLabel:SSKJLocalized(@"提示",nil) font:systemFont(ScaleW(15)) textColor:kMainTextColor frame:CGRectMake(ScaleW(15), ScaleW(37), self.showView.width - ScaleW(30), ScaleW(15)) textAlignment:NSTextAlignmentCenter];
...
-(UILabel *)messageLabel
{
    if (nil == _messageLabel) {
        _messageLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(12)) textColor:kMainTextColor frame:CGRectMake(ScaleW(15), self.titleLabel.bottom + ScaleW(23), self.showView.width - ScaleW(30), ScaleW(30)) textAlignment:NSTextAlignmentCenter];
    }
...
-(UIButton *)confirmButton
{
    if (nil == _confirmButton) {
        ...
        _confirmButton.layer.borderColor = kMainRedColor.CGColor;
        _confirmButton.layer.borderWidth = 0.5;
        _confirmButton.layer.cornerRadius = _confirmButton.height / 2;
        [_confirmButton setTitleColor:kMainRedColor forState:UIControlStateNormal];
